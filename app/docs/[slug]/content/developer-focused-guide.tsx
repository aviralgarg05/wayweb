  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
        <li><span className="text-secondary-db-100">Idempotency</span>: Use job IDs in requests to retry safely without duplicates.</li>
        <li><span className="text-secondary-db-100">Error Handling</span>: Standardized JSON errors with HTTP status codes.</li>
        <li><span className="text-secondary-db-100">File Security</span>: Temporary signed URLs for uploads/downloads; files auto-delete after 24 hours.</li>
        <li><span className="text-secondary-db-100">Versioning</span>: All endpoints prefixed with /v1/ for future-proofing.</li>
      </ul>
