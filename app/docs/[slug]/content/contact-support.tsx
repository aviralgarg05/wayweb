  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside text-secondary-db-70 font-regular text-xl leading-relaxed">
        <li><span className="text-secondary-db-100 font-semibold">Email</span>: Send a detailed message, including all diagnostic information, to info@waysorted.com.</li>
        <li><span className="text-secondary-db-100 font-semibold">In-App Support</span>: Use the support widget located in your Waysorted&apos;s plugin dashboard for direct access to our team.</li>
      </ul>
